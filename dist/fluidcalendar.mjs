import { openBlock, createElementBlock, Fragment, createCommentVNode, createElementVNode, normalizeClass, normalizeStyle, renderSlot, withModifiers, resolveComponent, toDisplayString, createVNode, withCtx, renderList, createBlock, createTextVNode, mergeProps } from 'vue';
          ...
          createElementVNode("div", {
            ...
            createElementVNode("div", {
              ...
              createElementVNode("div", {
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList($data._unavailabilities, (unavail) => {
                  ...
                  ,
                    ...
                    $options.translateX + $options.dateToX(unavail._start_at || unavail.start_at)
                        ...
                        default: withCtx(() => [
                          createElementVNode("span", _hoisted_5$2, toDisplayString(unavail.label), 1 /* TEXT */)
                        ]),
                        _: 2 /* DYNAMIC */
