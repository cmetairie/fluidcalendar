  ...
  return (vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.createElementVNode("div", _hoisted_1$7, [
      vue.createElementVNode("div", {
        ...
        style: vue.normalizeStyle($options.sltContent)
      }, [
...
function render$9(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("div", {
    class: vue.normalizeClass(["t__fluid__calendar__booking --unavailability", $options.clss]),
    style: vue.normalizeStyle($options.stl)
  }, [
    vue.createCommentVNode(" <button>m</button> "),
...
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("div", {
    class: vue.normalizeClass(["t__fluid__calendar__navigate", $options.clss]),
    ref: "scroller"
  }, [
    ($data.canScroll)
      ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 0,
          class: vue.normalizeClass(["t__fluid__calendar__navigate__btn", $options.clss]),
...
const _hoisted_2$3 = /*#__PURE__*/vue.createElementVNode("path", { d: "m15 18-6-6 6-6" }, null, -1 /* HOISTED */);
const _hoisted_3$3 = [
  _hoisted_2$3
];
const _hoisted_4$3 = {
  ...
  return (vue.openBlock(), vue.createElementBlock("div", {
    ...
    ($data.canScroll)
      ? (vue.openBlock(), vue.createElementBlock("div", {
          ...
          class: vue.normalizeClass(["t__fluid__calendar__navigate__btn", $options.clss]),
          onMousedown: _cache[0] || (_cache[0] = (...args) => ($options.startDrag && $options.startDrag(...args))),
          style: vue.normalizeStyle({ transform: `translate(${$data.tx}px, ${$data.ty}px)` }),
          ref: "btn"
        }, [
          vue.createCommentVNode(" {{ faking }} "),
          (!$props.total)
            ? (vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$5, [..._hoisted_3$3]))
            : vue.createCommentVNode("v-if", true),
          (!$props.total)
...
const _hoisted_20 = ["d"];
const _hoisted_21 = /*#__PURE__*/vue.createElementVNode("rect", {
  width: "100%",
  height: "100%",
  fill: "url(#grid)"
}, null, -1 /* HOISTED */);
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_FluidViewbar = vue.resolveComponent("FluidViewbar");
    ...
    vue.createVNode(_component_FluidPinch, {
      ...
      default: vue.withCtx(() => [
        vue.createElementVNode("div", {
          ...
          style: vue.normalizeStyle({ height: Math.min($options.fullHeight, $props.h) + 'px' }),
          ref: "fluidCalendar"
        }, [
            ...
            vue.createElementVNode("div", {
              ...
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.rangeY.rows, (bookable) => {
                return (vue.openBlock(), vue.createElementBlock("div", {
                  ...
                  (_ctx.$slots.bookable)
                    ? vue.renderSlot(_ctx.$slots, "bookable", {
                        key: 0,
                        bookable: bookable
                      })
          ...
          vue.createElementVNode("div", {
            ...
            vue.createElementVNode("div", {
              ...
              vue.createElementVNode("div", _hoisted_7$1, [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.unavailabilities, (unavail) => {
                  return (vue.openBlock(), vue.createBlock(_component_FluidDraggable, {
                    ...
                    default: vue.withCtx(() => [
                      (vue.openBlock(), vue.createBlock(_component_FluidCalendarUnavail, {
                ...
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.visibleBookings, (booking) => {
                  ...
                  ,
                        ...
                        default: vue.withCtx(() => [
                          ...
                          vue.createElementVNode("span", _hoisted_9$1, vue.toDisplayString($options.format(booking.start_at, 'time')) + " " + vue.toDisplayString(booking.label) + ", " + vue.toDisplayString($options.format(booking.end_at, 'time')), 1 /* TEXT */)
                        ]),
                        _: 2 /* DYNAMIC */
              ...
              vue.createElementVNode("div", {
                ...
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.rangeX.cells, (cell) => {
                  ...
                  width: `${$options.cellWidth}px`,
                    ...
                    vue.createCommentVNode(" <slot v-if=\"$slots.date\" name=\"date\" :date=\"cell\" /> "),
                    ...
                    ($options.displayHours)
                      ...
                      transform: `translateX(${hour.x}px)`,
                              ...
                              vue.createElementVNode("span", null, vue.toDisplayString(hour.label), 1 /* TEXT */)
                            ], 4 /* STYLE */))
                    ...
                    height: Math.min($options.fullHeight, $props.h) + 'px',
                          ...
                          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.areas, (i) => {
                            return (vue.openBlock(), vue.createElementBlock("div", _hoisted_17, [
              ...
              vue.createElementVNode("div", {
                ...
                (vue.openBlock(), vue.createElementBlock("svg", _hoisted_18, [
                  vue.createElementVNode("defs", null, [
                    vue.createElementVNode("pattern", {
                      id: "grid",
                      width: $options.cellWidth,
          ...
          vue.createCommentVNode(" <button class=\"t__fluid__calendar__next\" @click=\"next\"></button> "),
          vue.createCommentVNode(" <div class=\"t__fluid__calendar__scrollbar\">\n      <div class=\"t__fluid__calendar__scroll__area\" ref=\"scroll_area\">\n        <button class=\"t__fluid__calendar__scroller\"></button>\n      </div>\n    </div> ")
        ], 6 /* CLASS, STYLE */)
      ]),
      _: 3 /* FORWARDED */
...
const _hoisted_4$1 = /*#__PURE__*/vue.createElementVNode("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  fill: "none",
  stroke: "currentColor",
  ...
  /*#__PURE__*/vue.createElementVNode("path", { d: "m15 18-6-6 6-6" })
], -1 /* HOISTED */);
const _hoisted_5$1 = [
  _hoisted_4$1
];
const _hoisted_6 = /*#__PURE__*/vue.createElementVNode("svg", {
  ...
  /*#__PURE__*/vue.createElementVNode("path", { d: "m9 18 6-6-6-6" })
], -1 /* HOISTED */);
const _hoisted_7 = [
  _hoisted_6
];
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_FluidCalendarMobileBooking = vue.resolveComponent("FluidCalendarMobileBooking");

  return (vue.openBlock(), vue.createElementBlock("div", {
    class: "t__fluid__calendar__mobile",
    ref: "fluidCalendar",
    style: vue.normalizeStyle({ height: $props.h + 'px' })
  }, [
    ($props.debug)
    ...
    vue.createElementVNode("header", _hoisted_2$1, [
      vue.createElementVNode("div", _hoisted_3$1, [
        ...
        vue.createElementVNode("span", null, vue.toDisplayString($options.date), 1 /* TEXT */),
        vue.createElementVNode("button", {
      ...
      vue.createElementVNode("div", _hoisted_8, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.bookables, (bookable) => {
          ...
          }, vue.toDisplayString(bookable.label), 11 /* TEXT, CLASS, PROPS */, _hoisted_9))
        }), 256 /* UNKEYED_FRAGMENT */))
      ])
    ]),
    vue.createElementVNode("main", {
      ...
      ref: "main",
      onTouchstart: _cache[2] || (_cache[2] = vue.withModifiers((...args) => ($options.touchStart && $options.touchStart(...args)), ["prevent"]))
    }, [
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.visibleBookings, (booking) => {
        return (vue.openBlock(), vue.createBlock(_component_FluidCalendarMobileBooking, {
          booking: booking,
          heightByMinute: $options.heightByMinute
        }, {
          default: vue.withCtx(() => [
            (_ctx.$slots.booking)
              ...
              : (vue.openBlock(), vue.createElementBlock("span", _hoisted_10, vue.toDisplayString(booking.id) + " " + vue.toDisplayString(booking.label), 1 /* TEXT */))
          ]),
          _: 2 /* DYNAMIC */
      ...
      vue.createElementVNode("div", {
        ...
        vue.createElementVNode("div", _hoisted_11, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.rY.cells, (cell) => {
            return (vue.openBlock(), vue.createElementBlock("div", {
              class: vue.normalizeClass(["t__fluid__calendar__mobile__hour", { '--day': cell.time === '00:00' }]),
              style: vue.normalizeStyle({ height: `${$options.cellHeight}px` })
            }, [
              (cell.time === '00:00')
                ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_12, vue.toDisplayString(cell.short), 1 /* TEXT */))
                : (vue.openBlock(), vue.createElementBlock("span", _hoisted_13, vue.toDisplayString(cell.time), 1 /* TEXT */))
            ], 6 /* CLASS, STYLE */))
          }), 256 /* UNKEYED_FRAGMENT */))
        ])
      ], 4 /* STYLE */)
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock("div", {
    ...
    ($data.displayFR)
      ...
      : vue.createCommentVNode("v-if", true),
    ($data.desktop)
      ? (vue.openBlock(), vue.createBlock(_component_FluidCalendarDesktop, vue.mergeProps({ key: 1 }, _ctx.$props, {
          h: $data.h,
          w: $data.w,
          ...
          date: vue.withCtx(({date}) => [
            vue.renderSlot(_ctx.$slots, "date", { date: date })
          ]),
          booking: vue.withCtx(({booking}) => [
            vue.renderSlot(_ctx.$slots, "booking", { booking: booking })
          ]),
          bookable: vue.withCtx(({bookable}) => [
            vue.renderSlot(_ctx.$slots, "bookable", { bookable: bookable })
          ]),
          _: 3 /* FORWARDED */
        }, 16 /* FULL_PROPS */, ["h", "w"]))
      : vue.createCommentVNode("v-if", true),
    ($data.mobile)
      ? (vue.openBlock(), vue.createBlock(_component_FluidCalendarMobile, vue.mergeProps({ key: 2 }, _ctx.$props, {
          h: $data.h,
          w: $data.w,
